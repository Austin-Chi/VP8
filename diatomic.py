...
class CO_molecule:
    ...
    def com(self): # return position of center of mass
        return (self.O.m*self.O.pos+self.C.m*self.C.pos)/(self.O.m+self.C.m)
    ...
    def v_P(self): # return potential energy of the bond for the vibration motion
        return 0.5*k_bond*(mag(self.bond.axis)-d)*(mag(self.bond.axis)-d)
    def v_K(self): # return kinetic energy of the vibration motion
        return 0.5*self.C.m*(dot((self.C.v-self.com_v()), self.bond.axis)/mag(self.bond.axis))*(dot((self.C.v-self.com_v()), self.bond.axis)/mag(self.bond.axis))+0.5*self.O.m*(dot((self.O.v-self.com_v()), self.bond.axis)/mag(self.bond.axis))*(dot((self.O.v-self.com_v()), self.bond.axis)/mag(self.bond.axis))
    def r_K(self): # return kinetic energy of the rotational motion
        return 0.5*self.C.m*(mag(cross((self.C.v-self.com_v()), self.bond.axis))/mag(self.bond.axis))*(mag(cross((self.C.v-self.com_v()), self.bond.axis))/mag(self.bond.axis))+0.5*self.O.m*(mag(cross((self.O.v-self.com_v()), self.bond.axis))/mag(self.bond.axis))*(mag(cross((self.O.v-self.com_v()), self.bond.axis))/mag(self.bond.axis))
    def com_K(self): #return kinetic energy of the translational motion of the center of mass
        return 0.5*(self.C.m+self.O.m)*mag(self.com_v())*mag(self.com_v())
